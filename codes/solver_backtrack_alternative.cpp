...
An alternative implementation of our backtracking algorithm.
...
bool mustBacktrack(int i, int j) {
    ...
    bool shouldBacktrack = condA || condB || condC;
    if (N[R[i][j]] != -1 && !shouldBacktrack) {
        ...
        shouldBacktrack = condD || condE || condF;
    }
